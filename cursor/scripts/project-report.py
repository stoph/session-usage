...
Writes:
  <project>/.cursor/usage-logs/report.html
  <project>/.cursor/usage-logs/report-data.json
...
<main>
  ...
  <p class="help">
    ...
    <strong>Prompt total</strong> is all of those together (what Cursor reports as input tokens).

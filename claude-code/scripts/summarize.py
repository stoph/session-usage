#!/usr/bin/env python3
"""Summarize a Claude Code session usage JSONL into structured JSON.
...
def summarize(path: Path) -> dict:
    ...
    return {
        ...
        "notes": [
            ...
            "Prompt total is input_tokens: Input + Cache write + Cache read.",
            "For Claude Code, values are normalized from transcript usage blocks.",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Summarize Claude Code session usage logs")
